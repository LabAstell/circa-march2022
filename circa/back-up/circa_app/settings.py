"""
Django settings for circa_app project.
...
'''
SECRET_KEY = 'django-insecure-&s8y*-i0wf4(0&02isherwylbpt7m18%#*e+yv1edf*l^x&ky9'
...
WSGI_APPLICATION = 'circa_app.wsgi.application'
